...
#pactl load-module module-ladspa-sink sink_name=ladspa_pitch plugin="tap_pitch" label=tap_pitch control="0,0,0,1,1" master=echo-cancell
...
pactl load-module module-ladspa-sink sink_name=${SINKB} plugin="declip_1195" label=declip master=echo-cancell;
pactl load-module module-loopback master=${SINKB};

echo -e "\e[91m[VOCÊ] deve Ajustar volume do microfone e verificar volumes...\e[0m"
